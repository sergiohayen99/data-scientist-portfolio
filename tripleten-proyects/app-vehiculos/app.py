...
if graph_button:
    ...
    bar5 = px.bar(car_data, x = "fuel", title = "Tipo de combustible", labels = {"fuel":"Combustible"})
...
if graph_button:
    ...
    bar6 = px.bar(car_data, x = "transmission", title = "Tipo de transmisión", labels = {"transmission":"Transmisión"})
...
if graph_button:
    ...
    bar7 = px.bar(car_data, x = "type", title = "Tipo de vehículo", labels = {"type":"Tipo de vehículo"})
...
if graph_button:
    ...
    bar8 = px.bar(car_data, x = "paint_color", title = "Color del vehículo", labels = {"paint_color":"Color"})
...
if graph_button:
    ...
    hist1 = px.histogram(car_data, x = "price", title = "Precio del vehículo", labels = {"price":"Precio"})
...
if graph_button:
    ...
    hist2 = px.histogram(car_data, x = "odometer", title = "Nivel del odómetro", labels = {"odometer","Odómetro"})
...
if graph_button:
    ...
    hist3 = px.histogram(car_data, "days_listed", title = "Número de dias en la lista", labels = {"days_kisted":"No. días"})
...
if graph_button:
    ...
    scatter1 = px.scatter(car_data, x = "model_year", y = "price", title = "Comparativa entre el año del modelo y el precio de los vehículos")
